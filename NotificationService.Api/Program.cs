...
builder.Services.AddScoped<INotifService, NotifServiceImpl>();
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version     = "v1",
        Description = "Social interaction alerts — likes, comments, follows, mentions"
    });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ConnectSphere Notification API v1");
